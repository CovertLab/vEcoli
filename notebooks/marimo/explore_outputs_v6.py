...
def _(
    ...
    def pms(options, value=None, max_selections=500, placeholder="Select..."):
        """Drop-in `mo.ui.multiselect` replacement with pinned-selected UX.
        Returns a marimo UI element. Read selections via `pms_value(widget)`."""
...
def _(
    ...
    def val_chart(dataset_name):
        ...
        data_idxs = [
            val_options[dataset_name]["id"].index(name)
