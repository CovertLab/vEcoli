...
def generate_lineage(
    ...
    decorrelate_variant_seeds: bool = False,
):
    """
    ...
    Args:
        ...
        decorrelate_variant_seeds: If True, each variant ``i`` is given seeds
...
def generate_code(config):
    ...
    if generations:
        ...
        sim_imports, sim_workflow = generate_lineage(
            ...
            config.get("decorrelate_variant_seeds", False),
        )
    else:
