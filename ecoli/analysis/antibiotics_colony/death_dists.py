...
def plot_death_dists(
    ...
    '''Plot distributions of variables for cells that are one timestep away from death,
    cells that are more than one generation away from death, and cells whose lineages
    are uninterrupted for the duration of the simulation.
