...
def plot(
    ...
    # All variants on same plot, color by variant
    selection = alt.selection_point(fields=["variant"], bind="legend")
    ...
    chart = (
        ...
        .encode(
            ...
            detail="lineage_seed:N",  # This creates separate lines for each lineage_seed
            tooltip=["Doubling Time (hr)", "lineage_seed", "variant"],
    ...
    sim_avg = (
        ...
        .encode(
            ...
            y="Doubling Time (hr)",
            color=alt.Color("variant:N"),
            tooltip=["Doubling Time (hr)", "variant"],
        )
    )
