...
OUTPUT_COLUMN_NAMES: set[str] = {
    ...
    "listeners__monomer_degradation__monomers_degraded",
    ...
    "listeners__ribosome_data__activation_prob",
    ...
    "listeners__ribosome_data__is_n_ribosomes_to_activate_reduced",
    ...
    "listeners__ribosome_data__n_ribosomes_to_activate",
    ...
    "listeners__trna_charging__codons_read",
    "listeners__trna_charging__initial_disagreements",
    "listeners__trna_charging__initiated",
    "listeners__trna_charging__ribosome_initiation_argA",
    "listeners__trna_charging__ribosome_positions_argA",
    "listeners__trna_charging__saturation_trna",
