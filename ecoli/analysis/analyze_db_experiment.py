...
from ecoli.analysis.compartment_mass_fraction_summary import (
    Plot as CompartmentsMassFraction,
)
...
def main():
    ...
    parser.add_argument("--experiment_id", "-e", type=str, default=False)
    parser.add_argument(
        "--agent_id",
        "-a",
        type=str,
