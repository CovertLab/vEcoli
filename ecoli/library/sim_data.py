...
class LoadSimData:
    ...
    def __init__(
        ...
        if mar_regulon:
            ...
            new_deltaV = np.array([1e-3, 2.2e-4, 3.7e-5, 2.1e-5, 2.5e-6, 2.6e-5, 
                -1e-6, 1.2e-5, 3.7e-4, 1.3e-7, 1.4e-5, 1.7e-6, 2.9e-6,
                2.6e-4, 3.8e-6, 3.5e-7, -6.1e-7, 6.6e-8, 2.8e-5, 2.8e-2, 
                1.7e-4, 6.8e-5, 3.4e-6, 2.9e-4])
