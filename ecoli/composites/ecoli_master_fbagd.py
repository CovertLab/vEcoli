...
class Ecoli(Composer):
    ...
    def generate_processes(self, config):
        ...
        configs = {
            ...
            'metabolism': self.load_sim_data.get_metabolism_gd_config(time_step=time_step),
...
def run_ecoli(
    ...
    with open('gd-results.txt', 'w') as f:
        print(output['listeners']['fba_results'], file=f)
