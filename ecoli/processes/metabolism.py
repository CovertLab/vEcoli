...
class Metabolism(Process):
    ...
    defaults = {
        ...
        'amino_acid_ids': {},
        'linked_metabolites': None, # Problems with the new file that comes from wcEcoli parca
        'seed': 0,
        'deriver_mode': True}
        ...
        return {
            ...
            'listeners': {
                ...
                'fba_results': {
                    ...
                    'conc_updates': {'_default': [], '_updater': 'set', '_emit': True},
                    ...
                    'deltaMetabolites': {'_default': [], '_updater': 'set', '_emit': True},
                    'reactionFluxes': {'_default': [], '_updater': 'set', '_emit': True},
                    'externalExchangeFluxes': {'_default': [], '_updater': 'set', '_emit': True},
    ...
    def next_update(self, timestep, states):
        ...
        if self.use_trna_charging:
            conc_updates.update(self.update_amino_acid_targets(
                counts_to_mmolar,
                states['polypeptide_elongation']['aa_count_diff'], # for convinience-kinetics use: aa_conc_diff,
        ...
        if len(self.aa_targets):
            for aa, diff in count_diff.items():
                ...
                if self.aa_targets[aa] < 0:
                    ...
                    print('Target is negative for: ', aa)
...
class FluxBalanceAnalysisModel(object):
    ...
    def __init__(self, parameters, timeline=None, include_ppgpp=True):
        ...
        self.aa_names = parameters['aa_names']
    ...
    def set_molecule_levels(self, metabolite_counts, counts_to_molar,
                            coefficient, current_media_id, unconstrained, constrained, conc_updates, import_updates):
