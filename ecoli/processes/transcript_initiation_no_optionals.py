...
class TranscriptInitiation(Process):
    ...
    def next_update(self, timestep, states):
        ...
        update['listeners']['ribosome_data'] = {
            ...
            'rrn16S_init_prob': n_initiations[is_16Srrna].sum() / float(n_RNAPs_to_activate), #actual 16SrRNA initiation
        ...
        update['listeners']['rnap_data'] = {
            'didInitialize': n_RNAPs_to_activate, # num initialized
            'rnaInitEvent': TU_to_promoter.dot(n_initiations)} # vector of initiations foreach TU
